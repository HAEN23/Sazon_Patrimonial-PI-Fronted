    ...
    <div className={styles.vistaPrincipal}>
      ...
      <footer className={styles.footer}>
        ...
        <div className={styles.footerLogos}>
          <Image src="/logo_sp_blanco.png" alt="logo" width={70} height={70} />
          <Image src="/devbox_logo.png" alt="devbox" width={70} height={70} />
          <Image src="/logo_uni.png" alt="uni" width={70} height={70} />
        </div>
      </footer>
